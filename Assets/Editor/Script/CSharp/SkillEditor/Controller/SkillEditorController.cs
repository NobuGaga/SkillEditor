...
public static class SkillEditorController {
    ...
    public static void Start(string prefabPath) {
        ...
        SetAllAnimationClip();
        SkillEditorAnimationModel.AnimationClips = m_animationClips.ToArray();
        m_isGenericClip = SkillEditorAnimationModel.GenericState();
        InitAnimation();
        SkillEditorScene.RegisterSceneGUI();
        SkillEditorWindow.SetDisplayData(SkillEditorAnimationModel.AnimationClipNames, SkillEditorAnimationModel.AnimationClipIndexs);
    ...
    public static void SetAnimationClipData(int index) {
        SkillEditorAnimationModel.SetCurrentAnimationClip(index);
    }
    ...
    public static void Play() {
        ...
        if (m_isGenericClip)
            SkillEditorAnimator.Play(SkillEditorAnimationModel.SelectAnimationClip);
        else
            SkillEditorClip.Play(m_model, SkillEditorAnimationModel.SelectAnimationClip);
    }
