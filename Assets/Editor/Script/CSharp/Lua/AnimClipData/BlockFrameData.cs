...
namespace Lua.AnimClipData {
    ...
    public struct BlockFrameData : IFieldValueTable {
        ...
        public bool IsNullTable() => priority <= 0 || blockData.IsNullTable();
        public void Clear() {
            priority = 0;
            blockData.Clear();
        }
        ...
        private const string Key_BlockData = "data";
        ...
        public object GetFieldValueTableValue(string key) {
            switch (key) {
                ...
                case Key_BlockData:
                    return blockData;
                default:
                    Debug.LogError("BlockFrameData::GetFieldValueTableValue key is not exit. key " + key);
                    return null;
            }
        }
        ...
        public FieldValueTableInfo[] GetFieldValueTableInfo() {
            ...
            m_arraykeyValue[count] = new FieldValueTableInfo(Key_BlockData, ValueType.Table);
            return m_arraykeyValue;
        }
        #endregion
    }
